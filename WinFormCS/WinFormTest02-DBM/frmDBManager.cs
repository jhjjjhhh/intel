    ...
    public partial class frmDBManager : Form
    {
        ...
        private void mnuOpen_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == openFileDialog1.ShowDialog())
            {
                ...
                {
                    sbLabel3.Text = "Error opening database: " + ex.Message;
                }
            }
        }
        ...
        {
            if (fontDialog1.ShowDialog() == DialogResult.OK) //다이얼로그가 정상적으로 켜졌으면 
            {
                tbSql.Font = fontDialog1.Font; //다이얼로그에서 선택한 폰트를 에디터에 적용
